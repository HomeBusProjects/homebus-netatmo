...
require_relative 'lib/homebus-netatmo/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-netatmo'
  spec.version = HomebusNetatmo::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-netatmo'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-netatmo'
